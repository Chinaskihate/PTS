...
public static class UserRoles
{
    ...
    public const string TaskManagerRoles = TaskManager + "," + Admin + "," + RootAdmin + "," + TelegramBot;
    public const string TestManagerRoles = TestManager + "," + Admin + "," + RootAdmin + "," + TelegramBot;
