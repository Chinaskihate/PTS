...
const $generateApi = axios.create(
    {
        baseURL: process.env.REACT_APP_GENERATOR_URL
    }
)
...
$generateApi.interceptors.request.use(authInterceptor)


export {
    $authHost, $themeApi, $testApi, $taskApi, $historyApi, $generateApi
}